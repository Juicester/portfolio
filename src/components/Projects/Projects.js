		...
		<div>
			...
			<Container>
				...
				<Row className='row2'>
					...
					<Col className='proj6'>
						<Card>
							<Link to={{ pathname: 'https://home.adelphi.edu/~ju21229/assets/Spirit_Bomb/Final_Stuff/SpiritBomb.html'}} target='_blank'>
							<Card.Title>Spirit Bomb</Card.Title>
							<Card.Img src={SpiritBomb}/>
							</Link>
							<Card.Text>Spirit Bomb is a 3D Graphics example of custom shaders, scenes, and an imported model using Three.js. It depicts goku from Dragonball Z with a pulsing orb over his head.</Card.Text>
						</Card>
					</Col>
				</Row>
				<Row className='row3'>
					<Col className='proj7'>
						<Card>
							<Link to={{ pathname: 'https://home.adelphi.edu/~ju21229/assets/Rubics_Cube/RubicsCube.html'}} target='_blank'>
